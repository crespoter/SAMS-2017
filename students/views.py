...
def dashboard(request):
    ...
    try:
        ...
        for course in MyCourses:
            ...
            if(totalClasses == 0):
                ...
                retObj = dict(course=course,totalAttendance = (classesPresent*100.0/totalClasses),monthAttendance = "N.A")
            else:
                retObj = dict(course=course,totalAttendance = (classesPresent*100.0/totalClasses),monthAttendance = (totalClassesPresentInCurrentMonth*100.0/totalClassesIncurrentMonth))
    ...
    return render(request, "student/index.html", dict(name=user,attendanceContext=attendanceContext,assignmentContext = pendingAssignments))
